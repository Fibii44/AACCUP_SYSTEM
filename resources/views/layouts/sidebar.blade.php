    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        @if(auth()->user()->role === 'user')
          <li class="nav-item">
            <a class="nav-link {{ Request::is('faculty/dashboard') ? 'active' : '' }}" href="{{ route('tenant.facultyDashboard') }}">
        ...
        <li class="nav-item">
          <a class="nav-link {{ Request::is('instruments') ? 'active' : '' }}" href="{{ route('tenant.instruments.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Instruments</span>
          </a>
        </li>
        @if(auth()->user()->role !== 'user')
        <li class="nav-item">
          <a class="nav-link {{ Request::is('reports*') ? 'active' : '' }}" href="{{ route('tenant.reports') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
         <a class="nav-link {{ Request::is('user-table*') ? 'active' : '' }}" href="{{ route('tenant.user-table') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link nav-link {{ Request::is('settings') ? 'active' : '' }}  " href="{{ route('tenant.settings') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        @endif
        <li class="nav-item">
          <a class="nav-link {{ Request::is('Version_Testing') ? 'active' : '' }}" href="{{ route('tenant.version-testing.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>Version Testing</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                  <g transform="translate(-2169.000000, -745.000000)" fill="#FFFFFF" fill-rule="nonzero">
                    <g transform="translate(1716.000000, 291.000000)">
                      <g transform="translate(453.000000, 454.000000)">
            ...
            <span class="nav-link-text ms-1">Version Testing</span>
          </a>
        </li>
      </ul>
    </div>
